...
-  Clonarla ejecutando git clone https://github.com/julioavantt/teacher_react_conditional_rendering.git
...
-  [React Conditional Rendering](https://github.com/julioavantt/teacher_react_conditional_rendering)
   <br>
